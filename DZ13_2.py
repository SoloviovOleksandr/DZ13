from DZ13_1 import create_int_list, create_float_list, create_str_list
import time
...
def average_time(function, array_list,n):
    ...
    result = av_time/n
    print(f"{function.__name__} executed {n} times, values = {result}")
    return result
print(average_time(bubble_sort, create_int_list(5000),10))